...
use rust_sql_example::config::Config;
use rust_sql_example::dao::Database;
use rust_sql_example::{controllers, AppState};
...
async fn main() -> std::io::Result<()> {
    ...
    let app = HttpServer::new(move || {
        App::new()
            ...
            .configure(controllers::init_index_controller)
            .configure(controllers::init_user_controller)
            .configure(controllers::init_group_controller)
    })
